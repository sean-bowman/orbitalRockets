...
# -- Collection of commonly used functions [machiningProcesses] -- #

'''

Shared function repository for the machiningProcesses library.

Machining: cutting force, tool life, chatter stability and the distortion released by asymmetric material removal.
...
A NAMING NOTE. This module is called machiningUtils.py rather than utils.py, and that is deliberate.
...
MachiningError = EngineeringError
