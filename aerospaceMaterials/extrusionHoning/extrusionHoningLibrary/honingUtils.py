...
# -- Collection of commonly used functions [extrusionHoning] -- #

'''

Shared function repository for the extrusionHoning library.

Abrasive flow machining: media rheology, wall shear, the flow split across branching passages, and surface finish decay.
...
A NAMING NOTE. This module is called honingUtils.py rather than utils.py, and that is deliberate.
...
ExtrusionHoningError = EngineeringError
