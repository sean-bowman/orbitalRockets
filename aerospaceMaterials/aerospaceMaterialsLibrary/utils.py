...
# -- Collection of commonly used functions [aerospaceMaterials] -- #

'''

Shared function repository for the aerospaceMaterials library.
...
AerospaceMaterialsError = EngineeringError
