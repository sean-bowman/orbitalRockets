...
# -- Collection of commonly used functions [postProcessing] -- #

'''

Shared function repository for the postProcessing library.

Surface and post-processing: peening, chemical milling, electropolishing, plating and thermal spray.
...
A NAMING NOTE. This module is called surfaceUtils.py rather than utils.py, and that is deliberate.
...
SurfaceTreatmentError = EngineeringError
