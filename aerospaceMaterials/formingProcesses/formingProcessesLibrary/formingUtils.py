...
# -- Collection of commonly used functions [formingProcesses] -- #

'''

Shared function repository for the formingProcesses library.

Sheet and tube forming: bend radius, springback, forming limits and work hardening.
...
A NAMING NOTE. This module is called formingUtils.py rather than utils.py, and that is deliberate.
