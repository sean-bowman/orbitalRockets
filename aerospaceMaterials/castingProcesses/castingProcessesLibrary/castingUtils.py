...
# -- Collection of commonly used functions [castingProcesses] -- #

'''

Shared function repository for the castingProcesses library.

Investment, sand and die casting: solidification, riser sizing, and the casting factor that sets the allowable.
...
A NAMING NOTE. This module is called castingUtils.py rather than utils.py, and that is deliberate.
