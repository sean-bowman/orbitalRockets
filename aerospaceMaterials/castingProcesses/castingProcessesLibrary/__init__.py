...
as this repo (castingProcessesLibrary) is being called locally or is installed in the python
environment.
...
from castingUtils import *

from CastingProcess import *
