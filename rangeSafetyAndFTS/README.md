...
> **Status: complete.** Three classes, eleven documents and 56 tests, anchored to 14 CFR Part 450 read from the regulation.
...
**Risk follows population, not impact probability.** The downrange ocean takes 82 per cent of the debris and contributes 1 per cent of the casualty expectation; one coastal town takes 0.08 per cent of the debris and contributes 88 per cent of the risk. **A range safety analysis is a population analysis with a trajectory attached**, and the azimuth that minimises risk minimises overflown people rather than overflown distance.
...
`codeInterface.py` takes one coastal launch through the impact point, the risk analysis and the termination system.
...
| Collective Ec against its limit | 1.48e-5 against 1e-4 |
